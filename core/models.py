...
class Skill(models.Model):
    ...
    teaser_video = models.FileField(upload_to='skill_videos/', blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"{self.name} by {self.user.username}"

class TeaserView(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='teaser_views')
    skill = models.ForeignKey(Skill, on_delete=models.CASCADE, related_name='teaser_views')
